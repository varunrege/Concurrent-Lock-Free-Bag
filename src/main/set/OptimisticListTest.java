...
public class OptimisticListTest extends Thread {
    long elapsed;
    int iter;
    int threadCount;
    int cont_percentage;
    static OptimisticList<Integer> list = new OptimisticList<Integer>();

    public OptimisticListTest(int threadCount, int iter, int percent) {
